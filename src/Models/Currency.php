...
namespace Joy\VoyagerBreadCurrency\Models;
...
use Joy\VoyagerBreadCurrency\Database\Factories\CurrencyFactory;
...
class Currency extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Currency'));
    }
